            ...
            >
                ...
                <CardContent className="p-6 space-y-4 relative z-10">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-400">{volunteer.location}</p>
                    </div>

                    <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-300">Availability:</p>
                        <p className="text-sm text-gray-400">{volunteer.availability}</p>
                    </div>
                    ...
                    {!actionTaken && (
                        <div className="flex gap-2 mt-4">
                            <Button
                                ...
                                className={cn(
                                    "w-1/2 bg-green-500/20 text-green-300",
                            ...
                            <Button
                                ...
                                className={cn(
                                    "w-1/2 bg-red-500/20 text-red-300",
