...
import backgroundImage from "../../public/your-background-image.jpg"; // Replace with the actual path
...
export default function RegisterPage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${placeholderImage.src})`, // Use .src for Next.js public folder
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="volunteer">
              <Card className="bg-white/80 backdrop-blur-sm">
                ...
                <CardFooter className="flex flex-col space-y-4">
                  <Button className="w-full bg-rose-500 text-white hover:bg-rose-600">Create Account</Button>
            ...
            <TabsContent value="ngo">
              <Card className="bg-white/80 backdrop-blur-sm">
                ...
                <CardFooter className="flex flex-col space-y-4">
                  <Button className="w-full bg-rose-500 text-white hover:bg-rose-600">Create Organization Account</Button>
                  <div className="text-center text-sm text-gray-700">
                    Already have an account?{" "}
                    <Link href="/login" className="text-rose-500 hover:underline">
                      Sign in
